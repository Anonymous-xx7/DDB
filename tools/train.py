...
from dass.apis import init_random_seed, set_random_seed, train_segmentor
from dass.datasets import build_dataset
from dass.models import build_train_model
from dass.utils.collect_code import gen_code_archive
from mmseg import __version__
from mmseg.utils import collect_env, get_root_logger, setup_multi_processes
from dass.utils.wait_start import wait_for_allow_execution
...
def main():
    ...
    if args.work_dir is not None:
        ...
        if cfg.get("exp", None) is not None:
            ...
            cfg.work_dir = osp.join(cfg.work_dir, exp_name, unique_name)
        ...
        if cfg.get("exp", None) is not None:
            ...
            cfg.work_dir = osp.join("./work_dirs", exp_name, unique_name)
        else:
