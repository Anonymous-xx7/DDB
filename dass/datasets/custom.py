# Obtained from: https://github.com/open-mmlab/mmsegmentation/tree/v0.20.2
# Modifications:
    ...
    def evaluate(self, results, metric="mIoU", logger=None, gt_seg_maps=None, **kwargs):
        ...
        if mmcv.is_list_of(results, np.ndarray) or mmcv.is_list_of(results, str):
            if gt_seg_maps is None:
                ...
                print_log(
                    f"Loaded gt_seg_maps", logger=get_root_logger()
                )
            ...
            print_log(f"Eval {len(ret_metrics)} ret_metrics", logger=get_root_logger())
